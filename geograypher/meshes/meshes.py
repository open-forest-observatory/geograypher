...
class TexturedPhotogrammetryMesh:
    ...
    def export_covering_meshes(
        ...
        At each (x, y) square in the grid pyvista mesh will be sampled for the highest and lowest
        value which will be used to set the Z heights for that grid point (plus the z_buffer_m).
        Then upper and lower bound surfaces will be made from these grid points using
        delaunay_2d and returned.
        ...
        Args:
            ...
            subsample (int / None): If not None, we will naively subsample self.pyvista_mesh.points
                to speed up runtime by [::subsample]. Therefore a larger number will subsample
                more.
        """
