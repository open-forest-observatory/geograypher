    ...
    def aggregate_projected_images(
        ...
        **kwargs
        ...
        for projection_for_image in tqdm(
            ...
            old_values = summed_projections[projected_face_inds, projected_face_classes]
            incremented_old_values = old_values + 1

            summed_projections[projected_face_inds, projected_face_classes] = (
                incremented_old_values
            )
        ...
        # TODO actually perform the normalization by the counts
